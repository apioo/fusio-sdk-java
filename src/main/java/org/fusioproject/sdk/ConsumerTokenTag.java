...
public class ConsumerTokenTag extends TagAbstract {
    ...
    public ConsumerTokenAccessToken update(String tokenId, ConsumerTokenUpdate payload) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<ConsumerTokenAccessToken>(){});
            }
    ...
    public ConsumerToken get(String tokenId) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<ConsumerToken>(){});
            }
    ...
    public ConsumerTokenCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<ConsumerTokenCollection>(){});
            }

...
public class BackendConnectionTag extends TagAbstract {
    ...
    public BackendConnectionIntrospectionEntity getIntrospectionForEntity(String connectionId, String entity) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendConnectionIntrospectionEntity.class);
            }
    ...
    public BackendConnectionIntrospectionEntities getIntrospection(String connectionId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendConnectionIntrospectionEntities.class);
            }
    ...
    public BackendConnection get(String connectionId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendConnection.class);
            }
    ...
    public BackendConnectionIndex getClasses() throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendConnectionIndex.class);
            }
    ...
    public BackendConnectionCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendConnectionCollection.class);
            }

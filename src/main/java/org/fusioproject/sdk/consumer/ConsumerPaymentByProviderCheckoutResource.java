...
public class ConsumerPaymentByProviderCheckoutResource extends ResourceAbstract {
    ...
    public ConsumerPaymentByProviderCheckoutResource(String provider, String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public ConsumerPaymentByProviderCheckoutResource(String provider, String baseUrl, HttpClient httpClient) {

...
public class ConsumerRegisterResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public ConsumerRegisterResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public ConsumerRegisterResource(String baseUrl, HttpClient httpClient) {

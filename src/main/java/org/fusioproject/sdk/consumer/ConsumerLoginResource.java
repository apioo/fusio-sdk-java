...
public class ConsumerLoginResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public ConsumerLoginResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public ConsumerLoginResource(String baseUrl, HttpClient httpClient) {

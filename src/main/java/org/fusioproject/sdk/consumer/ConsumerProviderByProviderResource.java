...
public class ConsumerProviderByProviderResource extends ResourceAbstract {
    ...
    public ConsumerProviderByProviderResource(String provider, String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public ConsumerProviderByProviderResource(String provider, String baseUrl, HttpClient httpClient) {

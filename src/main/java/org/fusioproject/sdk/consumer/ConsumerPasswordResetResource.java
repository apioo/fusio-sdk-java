...
public class ConsumerPasswordResetResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public ConsumerPasswordResetResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public ConsumerPasswordResetResource(String baseUrl, HttpClient httpClient) {

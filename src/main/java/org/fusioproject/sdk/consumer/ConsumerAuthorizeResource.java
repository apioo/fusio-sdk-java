...
public class ConsumerAuthorizeResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public ConsumerAuthorizeResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public ConsumerAuthorizeResource(String baseUrl, HttpClient httpClient) {

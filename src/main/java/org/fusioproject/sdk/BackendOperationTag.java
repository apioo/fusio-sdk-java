...
public class BackendOperationTag extends TagAbstract {
    public BackendOperationTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public BackendOperation get(String operationId) throws ClientException {
        try {
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendOperation>(){});
     ...
     */
    public BackendOperationCollection getAll(Integer startIndex, Integer count, String search, Integer taxonomy) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendOperationCollection>(){});

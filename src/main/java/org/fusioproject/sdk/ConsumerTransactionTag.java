...
public class ConsumerTransactionTag extends TagAbstract {
    ...
    public ConsumerTransaction get(String transactionId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), ConsumerTransaction.class);
            }
    ...
    public ConsumerTransactionCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), ConsumerTransactionCollection.class);
            }

...
public class BackendFirewallTag extends TagAbstract {
    public BackendFirewallTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public CommonMessage create(BackendFirewallCreate payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/firewall", pathParams));
    ...
    public CommonMessage delete(String firewallId) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            pathParams.put("firewall_id", firewallId);

            Map<String, Object> queryParams = new HashMap<>();

            List<String> queryStructNames = new ArrayList<>();

            URIBuilder builder = new URIBuilder(this.parser.url("/backend/firewall/$firewall_id<[0-9]+|^~>", pathParams));
            this.parser.query(builder, queryParams, queryStructNames);
    ...
    public BackendFirewall get(String firewallId) throws ClientException {
        try {
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendFirewall>(){});
    ...
    public BackendFirewallCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendFirewallCollection>(){});

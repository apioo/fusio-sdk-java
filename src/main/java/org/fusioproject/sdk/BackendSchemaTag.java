...
public class BackendSchemaTag extends TagAbstract {
    ...
    public BackendSchema get(String schemaId) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendSchema>(){});
            }
    ...
    public BackendSchemaPreviewResponse getPreview(String schemaId) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendSchemaPreviewResponse>(){});
            }
    ...
    public BackendSchemaCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendSchemaCollection>(){});
            }

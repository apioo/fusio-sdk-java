...
public class BackendSchemaTag extends TagAbstract {
    ...
    public BackendSchema get(String schemaId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendSchema.class);
            }
    ...
    public BackendSchemaPreviewResponse getPreview(String schemaId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendSchemaPreviewResponse.class);
            }
    ...
    public BackendSchemaCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendSchemaCollection.class);
            }

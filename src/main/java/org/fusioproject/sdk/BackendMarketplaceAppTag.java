...
public class BackendMarketplaceAppTag extends TagAbstract {
    ...
    public MarketplaceApp get(String user, String name) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<MarketplaceApp>(){});
            }
    ...
    public MarketplaceAppCollection getAll(Integer startIndex, String query) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<MarketplaceAppCollection>(){});
            }

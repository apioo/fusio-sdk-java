...
public class BackendTrashTag extends TagAbstract {
    ...
    public BackendTrashDataCollection getAllByType(String type, Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendTrashDataCollection>(){});
            }
    ...
    public BackendTrashTypes getTypes() throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendTrashTypes>(){});
            }

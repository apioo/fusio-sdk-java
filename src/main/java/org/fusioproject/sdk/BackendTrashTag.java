...
public class BackendTrashTag extends TagAbstract {
    ...
    public BackendTrashDataCollection getAllByType(String type, int startIndex, int count, String search) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendTrashDataCollection.class);
            }
    ...
    public BackendTrashTypes getTypes() throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendTrashTypes.class);
            }

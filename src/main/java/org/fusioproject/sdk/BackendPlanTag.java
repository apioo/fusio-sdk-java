...
public class BackendPlanTag extends TagAbstract {
    public BackendPlanTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public CommonMessage delete(String planId) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/plan/$plan_id<[0-9]+|^~>", pathParams));
    ...
    public BackendPlan get(String planId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendPlan.class);
            }
    ...
    public CommonMessage create(BackendPlanCreate payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/plan", pathParams));
            this.parser.query(builder, queryParams);
    ...
    public BackendPlanCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendPlanCollection.class);
            }

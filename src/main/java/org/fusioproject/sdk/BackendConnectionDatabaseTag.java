...
public class BackendConnectionDatabaseTag extends TagAbstract {
    public BackendConnectionDatabaseTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public CommonMessage createRow(String connectionId, String tableName, BackendDatabaseRow payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/connection/:connection_id/database/:table_name/rows", pathParams));
    ...
    public CommonMessage createTable(String connectionId, BackendDatabaseTable payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/connection/:connection_id/database", pathParams));
            this.parser.query(builder, queryParams, queryStructNames);
    ...
    public CommonMessage deleteRow(String connectionId, String tableName, String id) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/connection/:connection_id/database/:table_name/rows/:id", pathParams));
            this.parser.query(builder, queryParams, queryStructNames);
    ...
    public CommonMessage deleteTable(String connectionId, String tableName) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/connection/:connection_id/database/:table_name", pathParams));
            this.parser.query(builder, queryParams, queryStructNames);

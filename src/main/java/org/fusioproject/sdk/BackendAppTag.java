...
public class BackendAppTag extends TagAbstract {
    ...
    public BackendApp get(String appId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendApp.class);
            }
    ...
    public BackendAppCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendAppCollection.class);
            }
    ...
    public BackendAppToken getToken(String tokenId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendAppToken.class);
            }
    ...
    public BackendAppTokenCollection getAllTokens(int startIndex, int count, String search, LocalDateTime from, LocalDateTime to, int appId, int userId, int status, String scope, String ip) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendAppTokenCollection.class);
            }

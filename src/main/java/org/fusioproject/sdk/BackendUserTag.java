...
public class BackendUserTag extends TagAbstract {
    ...
    public BackendUserCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendUserCollection.class);
            }

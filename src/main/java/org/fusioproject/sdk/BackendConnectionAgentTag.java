...
public class BackendConnectionAgentTag extends TagAbstract {
    public BackendConnectionAgentTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
     ...
     */
    public BackendAgentOutput send(String connectionId, BackendAgentInput payload) throws ClientException {
        try {

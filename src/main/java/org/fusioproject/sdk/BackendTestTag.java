...
public class BackendTestTag extends TagAbstract {
    public BackendTestTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public BackendTest get(String testId) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/test/$test_id<[0-9]+>", pathParams));
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendTest>(){});
    ...
    public BackendTestCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/test", pathParams));
            this.parser.query(builder, queryParams, queryStructNames);
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendTestCollection>(){});

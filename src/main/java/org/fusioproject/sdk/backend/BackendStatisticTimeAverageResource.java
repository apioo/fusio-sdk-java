...
public class BackendStatisticTimeAverageResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendStatisticTimeAverageResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendStatisticTimeAverageResource(String baseUrl, HttpClient httpClient) {
        this(baseUrl, httpClient, new ObjectMapper());
    }

    public Statistic_Chart backendActionStatisticGetTimeAverage(Backend_Log_Collection_Query query) throws URISyntaxException, IOException {

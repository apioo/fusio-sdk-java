...
public class BackendStatisticIssuedTokensResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendStatisticIssuedTokensResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendStatisticIssuedTokensResource(String baseUrl, HttpClient httpClient) {

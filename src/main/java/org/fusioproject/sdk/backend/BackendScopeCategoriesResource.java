...
public class BackendScopeCategoriesResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendScopeCategoriesResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendScopeCategoriesResource(String baseUrl, HttpClient httpClient) {

...
public class BackendConnectionFormResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendConnectionFormResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendConnectionFormResource(String baseUrl, HttpClient httpClient) {
        this(baseUrl, httpClient, new ObjectMapper());
    }

    public Form_Container backendActionConnectionGetForm(Form_Query query) throws URISyntaxException, IOException {

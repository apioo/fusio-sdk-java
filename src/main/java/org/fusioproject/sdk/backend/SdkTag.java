...
public class SdkTag extends TagAbstract {
    public SdkTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
        super(httpClient, objectMapper, parser);
    }


    public Message generate(SdkGenerate payload) throws ClientException {
        try {
    ...
    public SdkResponse getAll() throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), SdkResponse.class);
            }

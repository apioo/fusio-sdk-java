...
public class BackendConnectionListResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendConnectionListResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendConnectionListResource(String baseUrl, HttpClient httpClient) {

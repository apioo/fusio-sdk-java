...
public class BackendStatisticUsedPointsResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendStatisticUsedPointsResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendStatisticUsedPointsResource(String baseUrl, HttpClient httpClient) {
        this(baseUrl, httpClient, new ObjectMapper());
    }

    public Statistic_Chart backendActionStatisticGetUsedPoints(Backend_Plan_Usage_Collection_Query query) throws URISyntaxException, IOException {

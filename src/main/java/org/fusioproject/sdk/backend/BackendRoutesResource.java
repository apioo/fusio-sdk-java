...
public class BackendRoutesResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendRoutesResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendRoutesResource(String baseUrl, HttpClient httpClient) {

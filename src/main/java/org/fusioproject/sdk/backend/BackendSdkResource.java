...
public class BackendSdkResource extends ResourceAbstract {
    ...
    public BackendSdkResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendSdkResource(String baseUrl, HttpClient httpClient) {

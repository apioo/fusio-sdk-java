...
public class BackendGeneratorByProviderResource extends ResourceAbstract {
    ...
    public BackendGeneratorByProviderResource(String provider, String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendGeneratorByProviderResource(String provider, String baseUrl, HttpClient httpClient) {

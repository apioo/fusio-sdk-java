...
public class BackendCronjobByCronjobIdResource extends ResourceAbstract {
    ...
    public Message backendActionCronjobDelete() throws URISyntaxException, IOException {
        URIBuilder builder = new URIBuilder(this.url);

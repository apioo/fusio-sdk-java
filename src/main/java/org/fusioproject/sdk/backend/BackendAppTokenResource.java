...
public class BackendAppTokenResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendAppTokenResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendAppTokenResource(String baseUrl, HttpClient httpClient) {

...
public class ConfigTag extends TagAbstract {
    public ConfigTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
        super(httpClient, objectMapper, parser);
    }


    public Message update(String configId, ConfigUpdate payload) throws ClientException {
        try {
    ...
    public Config get(String configId) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            pathParams.put("config_id", configId);
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), Config.class);
            }
    ...
    public ConfigCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), ConfigCollection.class);
            }

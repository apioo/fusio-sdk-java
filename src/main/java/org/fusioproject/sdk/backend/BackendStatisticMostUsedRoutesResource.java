...
public class BackendStatisticMostUsedRoutesResource extends ResourceAbstract {
    ...
    public BackendStatisticMostUsedRoutesResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendStatisticMostUsedRoutesResource(String baseUrl, HttpClient httpClient) {
        this(baseUrl, httpClient, new ObjectMapper());
    }

    public StatisticChart backendActionStatisticGetMostUsedRoutes(BackendLogCollectionQuery query) throws URISyntaxException, IOException {

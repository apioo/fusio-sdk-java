...
public class PlanTag extends TagAbstract {
    ...
    public Message delete(String planId) throws ClientException {
        try {
    ...
    public Message update(String planId, PlanUpdate payload) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            pathParams.put("plan_id", planId);
    ...
    public Message create(PlanCreate payload) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
    ...
    public PlanCollection getAll() throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();

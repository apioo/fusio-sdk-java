...
public class BackendGeneratorResource extends ResourceAbstract {
    private final String url;
    private final HttpClient httpClient;
    private final ObjectMapper objectMapper;


    public BackendGeneratorResource(String baseUrl, HttpClient httpClient, ObjectMapper objectMapper) {
    ...
    public BackendGeneratorResource(String baseUrl, HttpClient httpClient) {

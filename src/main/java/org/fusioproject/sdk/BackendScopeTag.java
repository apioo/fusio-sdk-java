...
public class BackendScopeTag extends TagAbstract {
    ...
    public BackendScope get(String scopeId) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, BackendScope.class);
            }
    ...
    public BackendScopeCategories getCategories() throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, BackendScopeCategories.class);
            }
    ...
    public BackendScopeCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, BackendScopeCollection.class);
            }

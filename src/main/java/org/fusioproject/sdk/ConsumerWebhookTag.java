...
public class ConsumerWebhookTag extends TagAbstract {
    public ConsumerWebhookTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public CommonMessage create(ConsumerWebhookCreate payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/consumer/webhook", pathParams));
    ...
    public ConsumerWebhook get(String webhookId) throws ClientException {
        try {
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<ConsumerWebhook>(){});
    ...
    public ConsumerWebhookCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<ConsumerWebhookCollection>(){});

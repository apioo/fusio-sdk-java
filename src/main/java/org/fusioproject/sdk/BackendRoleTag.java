...
public class BackendRoleTag extends TagAbstract {
    public BackendRoleTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public BackendRole get(String roleId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendRole.class);
            }
    ...
    public BackendRoleCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendRoleCollection.class);
            }

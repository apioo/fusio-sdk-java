...
public class BackendActionTag extends TagAbstract {
    ...
    public BackendAction get(String actionId) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendAction.class);
            }
    ...
    public BackendActionExecuteResponse execute(String actionId, BackendActionExecuteRequest payload) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendActionExecuteResponse.class);
            }
    ...
    public BackendActionIndex getClasses() throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendActionIndex.class);
            }
    ...
    public BackendActionCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            ...
            if (statusCode >= 200 && statusCode < 300) {
                return this.parser.parse(EntityUtils.toString(response.getEntity(), "UTF-8"), BackendActionCollection.class);
            }

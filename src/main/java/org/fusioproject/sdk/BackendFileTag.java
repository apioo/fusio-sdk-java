...
public class BackendFileTag extends TagAbstract {
    public BackendFileTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public CommonMessage create(String connectionId, org.apache.hc.client5.http.entity.mime.MultipartEntityBuilder payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/file/:connection_id", pathParams));
     ...
     */
    public Passthru get(String connectionId, String fileId) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            pathParams.put("connection_id", connectionId);
            pathParams.put("file_id", fileId);

...
public class BackendWebhookTag extends TagAbstract {
    ...
    public BackendWebhook get(String webhookId) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendWebhook>(){});
            }
    ...
    public BackendWebhookCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendWebhookCollection>(){});
            }

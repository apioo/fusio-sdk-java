...
public class BackendWebhookTag extends TagAbstract {
    public BackendWebhookTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
    ...
    public CommonMessage create(BackendWebhookCreate payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/webhook", pathParams));
    ...
    public CommonMessage delete(String webhookId) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/backend/webhook/$webhook_id<[0-9]+|^~>", pathParams));
            this.parser.query(builder, queryParams, queryStructNames);
    ...
    public BackendWebhook get(String webhookId) throws ClientException {
        try {
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendWebhook>(){});
    ...
    public BackendWebhookCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<BackendWebhookCollection>(){});

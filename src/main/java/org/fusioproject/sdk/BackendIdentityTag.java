...
public class BackendIdentityTag extends TagAbstract {
    ...
    public BackendIdentity get(String identityId) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendIdentity>(){});
            }
    ...
    public BackendIdentityIndex getClasses() throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendIdentityIndex>(){});
            }
    ...
    public BackendIdentityCollection getAll(Integer startIndex, Integer count, String search) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, new TypeReference<BackendIdentityCollection>(){});
            }

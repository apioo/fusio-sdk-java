...
public class BackendIdentityTag extends TagAbstract {
    ...
    public BackendIdentity get(String identityId) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, BackendIdentity.class);
            }
    ...
    public BackendIdentityIndex getClasses() throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, BackendIdentityIndex.class);
            }
    ...
    public BackendIdentityCollection getAll(int startIndex, int count, String search) throws ClientException {
        try {
            ...
            if (resp.code >= 200 && resp.code < 300) {
                return this.parser.parse(resp.payload, BackendIdentityCollection.class);
            }
